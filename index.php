<!DOCTYPE html>
<!-- saved from url=(0044)https://sistemas.sobral.ifce.edu.br/formRED/ -->
<html lang="pt-br">
...
<head>
  ...
  <!-- faz com que a pagina não interprete os números na página como números de telefone -->
  ...
  <!-- Favicons -->
  <link href="https://sistemas.sobral.ifce.edu.br/formRED/img/favicon7.png" rel="icon">
  <link href="https://sistemas.sobral.ifce.edu.br/formRED/img/apple-touch-icon.png" rel="apple-touch-icon">
  <!-- Google Fonts -->
  <link href="./ifcesistemas_files/css" rel="stylesheet">
  <!-- Bootstrap CSS File -->
  <link href="./ifcesistemas_files/bootstrap.min.css" rel="stylesheet">
  <!-- Libraries CSS Files -->
  <link href="./ifcesistemas_files/font-awesome.min.css" rel="stylesheet">
  <link href="./ifcesistemas_files/animate.min.css" rel="stylesheet">
  <link href="./ifcesistemas_files/ionicons.min.css" rel="stylesheet">
  <link href="./ifcesistemas_files/owl.carousel.min.css" rel="stylesheet">
  <link href="./ifcesistemas_files/lightbox.min.css" rel="stylesheet">

  <link rel="stylesheet" href="./ifcesistemas_files/style.css">
  ...
  <link type="text/css" rel="stylesheet" href="./ifcesistemas_files/css2">
  <link type="text/css" rel="stylesheet" href="./ifcesistemas_files/css2">
</head>
...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <a href="https://sistemas.sobral.ifce.edu.br/" class="scrollto" style="float: left; margin: 0 auto; margin-left: 20px;"><img src="./ifcesistemas_files/logo_ifce2.png" alt="" class="img-fluid" height="48" width="52"></a>

    <div class="container">

      <div class="logo float-left">

        <a href="https://sistemas.sobral.ifce.edu.br/" class="scrollto">
          <h3>
            <font style="color:white; font-weight: normal;">IFCE - SISTEMAS</font>
          </h3>
        </a>
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          <li><a href="/ifce/provoc.php">Clique aqui para acessar somente a Landing Page do PROVOC</a></li>
  ...
  <section id="intro2" class="clearfix">
    ...
    <div style="position: absolute; width: 100%; height: 25%; bottom: 0;margin-bottom: 5px;">
      <form style="float: left; margin-left: 10px;">
        <button type="button" class="btn btn-secondary btn-sm" onclick="history.go(-1)">« Voltar
        </button>
      </form>
    </div>
  </section>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        ©2025 <strong>IFCE - SOBRAL</strong><br>Coordenação de Tecnologia da Informação - CTI
      </div>
      <div class="credits" style="margin-top: 20px;">
        Themplate Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a>
      </div>
    </div>
  </footer><!-- #footer -->
